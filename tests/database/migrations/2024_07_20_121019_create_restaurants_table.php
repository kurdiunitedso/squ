...
class CreateRestaurantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('restaurants', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('bank_branch')->nullable()->index('restaurants_bank_branch_foreign');
            ...
            $table->integer('has_marketing_center')->default(0);
            ...
            $table->foreign('bank_name', 'restaurants_bank_name_foreign')->references('id')->on('constants');
            $table->foreign('city_id', 'restaurants_city_id_foreign')->references('id')->on('cities');
            $table->foreign('country_id', 'restaurants_country_id_foreign')->references('id')->on('countries');
            $table->foreign('payment_type', 'restaurants_payment_type_foreign')->references('id')->on('constants');
            $table->foreign('pos_type', 'restaurants_pos_type_foreign')->references('id')->on('constants');
            $table->foreign('printer_type', 'restaurants_printer_type_foreign')->references('id')->on('constants');
            $table->foreign('type_id', 'restaurants_type_id_foreign')->references('id')->on('constants');
        });
    }
