...
class ConstantsTableSeederV3 extends Seeder
{
    /**
    ...
    protected array $constants = [
        [
            ...
            'items' => [
                [
                    'field' => DropDownFields::objective_type,
                    'values' => DropDownFields::objective_type_list
                ],

            ]
        ],
        [
            'module' => Modules::offer_module,
            'items' => [
                [
                    'field' => DropDownFields::offer_status,
                    'values' => DropDownFields::offer_status_list
                ],
    ...
    private function seedConstants(string $module, string $field, array $values): void
    {
        ...
        foreach ($values as $key => $value) {
            try {
                ...
                $constantData = [
                    'name' => splitAndUppercase($constantName),
                    'name_ar' => t(splitAndUppercase($constantName), [], 'ar'),
                    'value' => $value,
                    'parent_id' => null,
                ];
