<div class="row">
        ...
        <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                ...
                @foreach ($BANKS as $BANK)
                    ...
                    @isset($employee)
                        @selected($employee->bank_name == $BANK->id)
                        @endisset>
                        {{ $BANK->name }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" name="bank_iban" class="form-control form-control-solid mb-3 mb-lg-0"
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" name="bank_account" class="form-control form-control-solid mb-3 mb-lg-0"
