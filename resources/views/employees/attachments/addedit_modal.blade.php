  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_attachment_form" class="form"
              ...
              action="{{ isset($attachment) ? route('employees.attachments.update', ['employee' => $employee->id, 'attachment' => $attachment->id]) : route('employees.attachments.store', ['employee' => $employee->id]) }}">
