                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-whours-table-toolbar="base">
                        ...
                        <div class="d-flex justify-content-end" data-kt-employees-table-toolbar="base">
                            ...
                            @include('employees.working_hours._filter')


                            <a target="_blank" id="exportBtn" href="#"
                               data-export-url="{{ route('employees.whours.export',["employee"=>$employee]) }}" class="btn btn-primary me-3 exportBtn">
                                <i class="ki-duotone ki-exit-down fs-2"><span class="path1"></span><span
                                        class="path2"></span></i> {{__('Export')}}
                            </a>
                            <a target="_blank" id="exportBtn2" href="#"
                               data-export-url="{{ route('employees.whours.export',["employee"=>$employee]) }}?timesheet=1" class="btn btn-warning me-3 exportBtn">
                                <i class="ki-duotone ki-exit-down fs-2"><span class="path1"></span><span
                                        class="path2"></span></i> {{__('Export Time Sheet')}}
                            </a>
                        </div>
                    </div>
            ...
            var initWhours = (function () {
                ...
                return function () {
                    ...
                    datatableWhour = createDataTable('#kt_table_whours', columnDefs,
                        "{{ route('employees.whours.index', ['employee' => isset($employee)?$employee->id:0]) }}",
                        [
                            [0, "DESC"]
                        ]);
