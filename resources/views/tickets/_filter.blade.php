        ...
        <form id="filter-form" class="px-7 py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mb-10 ">
                        <!--begin::Label-->
                        <label class="form-label fw-semibold">{{__('Ticket Date')}}:</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <div class="">
                            <input class="form-control form-control-solid datatable-input " data-col-index="ticket_date"
                ...
                <div class="col-md-3">
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid datatable-input filter-selectpicker"
                                    data-kt-select2="true" multiple data-col-index="priority"
                ...
                <div class="col-md-3">
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid datatable-input filter-selectpicker"
                                    data-kt-select2="true" multiple data-col-index="purpose"
                                    data-placeholder="Select option"
                                    data-dropdown-parent="#kt_menu_64ca1a18f399e" data-allow-clear="true">
                                <option></option>
