    ...
    <div class="card-body p-9">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="fv-row mb-4">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2">{{__('Insurance Company')}}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                            name="insurance_company_id" id="insurance_company_id" data-placeholder="Select an option">
                        <option></option>
                        @foreach (\App\Models\InsuranceCompany::all() as $t)
                            <option value="{{ $t->id }}"
                            @if (isset($client))
                                @selected($client->insurance_company_id ==$t->id)
                                @endif>
                                {{ $t->name }}</option>
                        @endforeach
                    </select>
