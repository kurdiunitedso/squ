        ...
        <div class="card mb-5 mb-xl-10" id="kt_client_attachments_details_view">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">{{__('Client Attachments')}}</h3>
                </div>
            ...
            <div class="card-body p-9">
                <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                    id="kt_table_client_attachments">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
    ...
    <script>
        var table = document.querySelector('#kt_table_client_attachments');
        ...
        var datatable = $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('clients.attachments', ['client' => $client->id]) }}",
                type: "POST",
                data: function(d) {
                    // var params = {};
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function(e) {
            e.preventDefault();
            $(this).attr("data-kt-indicator", "on");
            renderModalAtt("{{ route('clients.attachments.create', ['client' => $client->id]) }}", $(this));
        });
    ...
    <script>
        $(document).on('click', '.btnDeleteClientAttachment', function(e) {
            e.preventDefault();
