        ...
        <div class="card mb-5 mb-xl-10" id="kt_client_attachments_details_view">
            ...
            <div class="card-header">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Client Audit History</h3>
                </div>
            ...
            <div class="card-body p-9">
                ...
                <div class="tab-content">
                    <div id="kt_client_activity" class="card-body p-0 tab-pane fade show active" role="tabpanel"
                        aria-labelledby="kt_client_activity_tab">
                        <div class="timeline">
                            <!--begin::Timeline item-->
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            ...
                                            <div class="pe-3 mb-5">
                                                ...
                                                <div class="fs-5 fw-semibold mb-2">
                                                    {{ ucfirst($audit->event) }} Client Information</div>
                                                <!--end::Title-->
                                            ...
                                            {{ $audit->user->name }}</div> --}}
                                                    ...
                                                    <div class="text-muted me-2 fs-7">@lang('client.updated.metadata', $metadata)</div>
                                                    <!--end::Info-->
                                                ...
                                                <ul class="list-group">
                                                    @foreach ($audit->getModified() as $attribute => $modified)
                                                        ...
                                                        @if (
                                                            ...
                                                            <li class="list-group-item">@lang('client.' . $audit->event . '.modified.' . $attribute, $modified)</li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                                    ...
                                    @else
                                        <div class="timeline-content mb-10 mt-n1">
                                            ...
                                            <div class="pe-3 mb-5">
                                                <!--begin::Title-->
                                                <div class="fs-5 fw-semibold mb-2">
                                                    {{ ucfirst($audit->event) }} Client</div>
                                                <!--end::Title-->
                                        ...
                                        {{ $audit->user->name }}</div> --}}
                                                    ...
                                                    <div class="text-muted me-2 fs-7">@lang('client.' . $audit->event . '.metadata', $metadata)</div>
                                                    <!--end::Info-->
                    ...
                    <div id="kt_client_attachments_activity" class="card-body p-0 tab-pane fade" role="tabpanel"
                        aria-labelledby="kt_client_attachments_activity_tab">
                        <div class="timeline">
                            <!--begin::Timeline item-->
                                    ...
                                    @if ($audit->event == 'updated')
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            ...
                                            <div class="pe-3 mb-5">
                                                <!--begin::Title-->
                                                <div class="fs-5 fw-semibold mb-2">
                                                    {{ ucfirst($audit->event) }} Client Attachment</div>
                                                <!--end::Title-->
                        ...
                        @if (count($attachmentAudits) == 0)
                            <p>@lang('client.unavailable_attachments_audits')</p>
                        @endif
                    </div>
                </div>
            </div>
