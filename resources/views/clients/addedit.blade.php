            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                @isset($client)
                    <a href="#" id="AddvisitsModal"
                       url="{{route('visitRequests.create')}}?telephone={{$client->mobile1}}&visit_name={{$client->name}}&visit_category=250"
                       class="btn btn-info me-3">
                        ...
                        <span id="selectedClientsRowsCount"></span>Visit Request</a>
                @endisset
