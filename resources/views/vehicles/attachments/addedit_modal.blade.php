  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_attachment_form" class="form"
              ...
              action="{{ isset($attachment) ? route('vehicles.attachments.update', ['vehicle' => $vehicle->id, 'attachment' => $attachment->id]) : route('vehicles.attachments.store', ['vehicle' => $vehicle->id]) }}">
