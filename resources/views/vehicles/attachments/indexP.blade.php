    ...
    <div>
        <div class="card mb-5 mb-xl-10" id="kt_vehicle_attachments_details_view">
            <!--begin::Card header-->
            <div class="card-header">
                <!--begin::Card title-->
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Vehicle Attachments</h3>
                </div>
            ...
            <div class="card-body p-9">
                <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                    id="kt_table_vehicle_attachments">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
    ...
    <script>
        var table = document.querySelector('#kt_table_vehicle_attachments');
        ...
        var datatable = $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('vehicles.attachments', ['vehicle' => $vehicle->id]) }}",
                type: "POST",
                data: function(d) {
                    // var params = {};
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function(e) {
            e.preventDefault();
            $(this).attr("data-kt-indicator", "on");
            renderModalAtt("{{ route('vehicles.attachments.create', ['vehicle' => $vehicle->id]) }}", $(this));
        });
    ...
    <script>
        $(document).on('click', '.btnDeleteVehicleAttachment', function(e) {
            e.preventDefault();
