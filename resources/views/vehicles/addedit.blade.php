...
@section('title', 'Vehicle-' . 'Add new vehicle')
@section('subpageTitle', 'Vehicle')
@section('subpageName', 'Add new vehicle')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_vehicle_form_tabs">
        <div class="card-body pt-0 pb-0">
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($vehicle) ? '' : 'disabled' }}"
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('vehicles.index') }}" class="btn btn-sm btn-light me-2"
                ...
                <a href="#" class="btn btn-sm btn-primary ms-5" data-kt-vehicle-action="submit">
    ...
    <form class="tab-content" id="myTabContent" method="post"
          action="{{ route('vehicles.addedit', ['Id' => isset($vehicle) ? $vehicle->id : '']) }}?{{ isset($vehicle) ? 'vehicle_id=' . $vehicle->id : '' }}">
        @csrf
        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_vehicle_details_view">
                <!--begin::Card header-->
            ...
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if(isset($vehicle))
                        ...
                        @include('vehicles.attachments.index')
                    @endif
...
@push('scripts')
    ...
    <script>
        ...
        function renderValidate() {
            ...
            const submitButton = document.querySelector('[data-kt-vehicle-action="submit"]');
