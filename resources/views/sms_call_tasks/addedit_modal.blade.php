  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_sms_form" class="form" data-editMode="{{ isset($sms) ? 'enabled' : 'disabled' }}"
              action="{{ route('sms.callTask.store', ['callTask' => $callTask->id]) }}">
              <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_sms_scroll" data-kt-scroll="true"
                  ...
                  <div class="fv-row mb-4">
                      <!--begin::Label-->
                      <label class="fw-semibold fs-6 mb-2">CallTask:</label>
                      <!--end::Label-->
                      <!--begin::Input-->
                      <input type="text" disabled class="form-control mb-3 mb-lg-0" value="{{ $callTask->call->client_name }}" />
                      <!--end::Input-->
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="fv-row mb-7">
                              <!--begin::Label-->
                              <label class="required fw-semibold fs-6 mb-2">Message Type</label>
                              <!--end::Label-->
                              <!--begin::Input-->
                              <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                  ...
                                  @foreach ($SHORT_MESSAGE_TYPES as $SHORT_MESSAGE_TYPES_ITEM)
                                      <option value="{{ $SHORT_MESSAGE_TYPES_ITEM->id }}"
                                          @if (isset($sms)) @selected($sms->type_id ==$SHORT_MESSAGE_TYPES_ITEM->id) @endif>
                      ...
                      <div class="col-md-6">
                          <div class="fv-row mb-4">
                              ...
                              <input type="text"   name="to" class="form-control form-control-solid mb-3 mb-lg-0"
                                  placeholder="Mobile Number" value="{{ isset($sms) ? $sms->to : $callTask->call->telephone }}" />
                              <!--end::Input-->
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="fv-row">
                      ...
                      <!--begin::Input-->
                      <div class="mb-3">
                          <textarea name="text" id="text" rows="4" class="form-control form-control-solid mb-3 mb-lg-0">{{ isset($sms) ? $sms->text : '' }}</textarea>
                      </div>
                      <!--end::Input-->
                  </div>
                  <!--end::Input group-->
  ...
  <script>
      $(function() {
          ...
          var local_callTask_name_ar = '{{ $callTask->name }}';
          $('#type_id').on('select2:select', function(e) {
              var selectedData = e.params.data;
              var template = templates.find(el => el.value == selectedData.text.trim());
              let result = template.name.replace("<callTask>", local_callTask_name_ar);
              $('#text').text(result);
          });
