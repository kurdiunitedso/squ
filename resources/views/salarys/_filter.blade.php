            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid datatable-input filter-selectpicker"
                                    data-kt-select2="true" multiple data-col-index="month_id" data-placeholder="Select option"
                                    data-dropdown-parent="#kt_menu_64ca1a18f399e" data-allow-clear="true">
                                <option></option>
                ...
                <div class="col-md-3">
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid datatable-input filter-selectpicker"
                                    data-kt-select2="true" multiple data-col-index="year_id" data-placeholder="Select option"
                                    data-dropdown-parent="#kt_menu_64ca1a18f399e" data-allow-clear="true">
                                <option></option>
                ...
                <div class="col-md-3">
                    <div class="mb-10 ">
                        <!--begin::Label-->
                        <label  class="form-label fw-semibold">{{__('Salary Date')}}:</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <div class="">
                            <input  class="datatable-input  form-control date-flatpickr form-control-solid mb-3 mb-lg-0" data-col-index="created_at"
                            />
                        </div>
                        <!--end::Input-->
                    </div>
