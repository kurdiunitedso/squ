...
@section('content')
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 active  {{ isset($employee) ? '' : 'disabled' }}"
                           data-bs-toggle="tab"
    ...
    <form class="tab-content" id="myTabContent" method="post"
          action="{{ route('myemployees.addedit', ['Id' => isset($employee) ? $employee->id : '']) }}?{{ isset($employee) ? 'employee_id=' . $employee->id : '' }}">
        @csrf
        <div class="tab-pane fade  " id="kt_tab_pane_employee" role="tabpanel">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if(isset($employee))
                        ...
                        @include('myemployees.attachments.index')
                    @endif
        ...
        <div class="tab-pane fade active show" id="kt_tab_pane_whour" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_whour_details_view">
                <!--begin::Card header-->
                @if(isset($employee))
                    @include('myemployees.working_hours.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
