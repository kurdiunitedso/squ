...
@push('scripts')
    ...
    <script>
        setInterval(function() {
            ...
            $.ajax({
                url: '/getWhatsAppMessage?mobile=' + mobile + "&patient=" + patient + "&sender=" + sender +
                    "&limit=10",
                ...
                complete: function() {
                    let a = parseFloat(($('.scrollWhatApp').prop("scrollHeight"))) - parseFloat($(
                        '.scrollWhatApp').scrollTop());
                    console.log(a);
                    if (a < 900) {
        ...
        $(".searchWhatClickChat").on('click', function() {
            jQuery('.messagesWhatApp').html(
                '<div class="spinner spinner-primary spinner-lg spinner-center"></div><br><br>');
            var mobile = $("#chat_mobile").val();
            var sender = $("#chat_sender").val();
            var patient = $("#chat_patient").val();
            var thisDiv = jQuery('.scrollWhatApp');
            ...
            $.ajax({
                url: 'crm/general/getWhatsAppMessage?mobile=' + mobile + "&patient=" + patient +
                    "&search=1&sender=" + sender + "&inputsearch=" + searchinput,
                success: function(data) {
        ...
        $(".searchWhatCloseChat").on('click', function() {
            ...
            $.ajax({
                url: 'crm/general/getWhatsAppMessage?mobile=' + mobile + "&patient=" + patient +
                    "&sender=" + sender + "&search=1&inputsearch=" + searchinput,
                success: function(data) {
                    thisDiv.find('.messagesWhatApp').html(data);
                },
                beforeSend: function() {
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function(e) {
            ...
            renderModal("{{ route('dashboard.createAtt') }}?sender={{ $sender }}&mobile={{ $mobile }}",
                $(this));
        });
    </script>
@endpush
@section('content')
    ...
    <div class="" datatable="datatable" item_id="0" id="wa_chat_modal" role="dialog" data-backdrop="false">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header align-items-center px-4 py-3">
                        ...
                        <div data-kt-search-element="form" class="w-100 position-relative mb-5" autocomplete="off">
                            ...
                            <!--begin::Icon-->
                            <i
                                class="ki-duotone searchWhatClickChat ki-magnifier fs-2 fs-lg-1 text-gray-500 position-absolute top-50 ms-5 translate-middle-y"><span
                            ...
                            <input type="text"
                                ...
                                name="inputsearchWhat" value="" placeholder="Search " data-kt-search-element="input">
                            <!--end::Input-->
                    ...
                    <div class="card-body">
                        <!--begin::Scroll-->
                        <div class="scrollWhatApp scroll ">
                    ...
                    <form id="fromWhatsApp">
                        <div class="card-footer align-items-center">
                            ...
                            <textarea class="form-control border-0 p-0" rows="2" id="chat_message" name="message"
