    ...
    <div class="card mb-5 mb-xl-10" id="kt_captin_attachments_details_view">
        ...
        <div class="card-header">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Captin Attachments</h3>
            </div>
        ...
        <div class="card-body p-9">
            <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                id="kt_table_captin_attachments">
                <!--begin::Table head-->
                <thead>
                    <!--begin::Table row-->
...
@push('scripts')
    <script>
        var table = document.querySelector('#kt_table_captin_attachments');
        ...
        var datatableAtt = $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('departments.attachments', ['department' => $item_model->id]) }}",
                type: "POST",
                data: function(d) {
                    // var params = {};
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function(e) {
            e.preventDefault();
            $(this).attr("data-kt-indicator", "on");
            renderModal("{{ route('captins.departments.create', ['department' => $item_model->id]) }}", $(this));
        });
    </script>


    <script>
        $(document).on('click', '.btnDeleteCaptinAttachment', function(e) {
            e.preventDefault();
