...
@section('title', 'Department-' . 'Add new Department')
@section('subpageTitle', 'Department')
@section('subpageName', 'Add new Department')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_department_form_tabs">
        <div class="card-body pt-0 pb-0">
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('departments.index') }}" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
    ...
    <form class="tab-content" id="myTabContent" method="post"
        action="{{ route('departments.addedit', ['Id' => isset($item_model) ? $item_model->id : '']) }}?{{ isset($item_model) ? 'department_id=' . $item_model->id : '' }}">
        @csrf
            ...
            <div class="card mb-5 mb-xl-10" id="kt_captin_details_view">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">{{ __('Department Details') }}</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
        ...
        {{-- <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if (isset($item_model))
                        @include('departments.attachments.index')
                    @endif
        ...
        <div class="tab-pane fade" id="kt_tab_pane_history" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_history_view">
                ...
                <div class="card-body p-9">
                    ...
                    @include('departments.history.index')
