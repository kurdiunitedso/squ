...
@section('subpageTitle', 'Departments')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-col-index="search" data-kt-departments-table-filter="search"
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-departments-table-toolbar="base">
                            ...
                            <a target="_blank" id="exportBtn" href="#"
                                data-export-url="{{ route('departments.export') }}" class="btn btn-primary me-3">
                                <i class="ki-duotone ki-exit-down fs-2"><span class="path1"></span><span
                                        class="path2"></span></i> {{ __('Export') }}
                            </a>
                            <!--end::Filter-->
                            <!--begin::Add captins-->
                            <a href="{{ route('departments.create') }}" class="btn btn-primary" id="AddcaptinsModal">
...
@push('scripts')
    <script>
        ...
        var datatable = createDataTable('#kt_table_items_model', columnDefs, "{{ route('departments.index') }}", [
            [0, "ASC"]
        ]);
    ...
    <script>
        $(document).on('click', '.btnDeleteItemModel', function(e) {
            e.preventDefault();
            const URL = $(this).attr('href');
            const itemModelName = $(this).attr('data-item-model-name');
            Swal.fire({
