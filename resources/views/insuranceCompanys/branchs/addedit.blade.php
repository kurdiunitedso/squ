...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_branch_form" class="form"
              ...
              action="{{ isset($branch) ? route('insuranceCompanys.branchs.update', ['branch' => $branch->id]) : route('insuranceCompanys.branchs.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_branch_scroll" data-kt-scroll="true"
                ...
                <input type="hidden" name="insurance_company_id" value="{{$insuranceCompany->id}}">
                @if(isset($branch))
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($branch) ? $branch->name : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <label class="required fw-semibold fs-6 mb-2"
                                   data-input-name="City">{{ __('City') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="email" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($branch) ? $branch->email : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" data-input-name="Price">{{ __('Fax') }}
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="fax" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($branch) ? $branch->fax : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" data-input-name="FloorNar">{{ __('Floor') }}
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="floor" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($branch) ? $branch->floor : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                </div>
