...
@section('title', 'InsuranceCompany-' . 'Add new insuranceCompany')
@section('subpageTitle', 'InsuranceCompany')
@section('subpageName', 'Add new insuranceCompany')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_insuranceCompany_form_tabs">
        <div class="card-body pt-0 pb-0">
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2" id="tabbank">
                    ...
                    <li class="nav-item mt-2" id="tab2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($insuranceCompany) ? '' : 'disabled' }} "
                           data-bs-toggle="tab"
                    ...
                    <li class="nav-item mt-2" id="tab22">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($insuranceCompany) ? '' : 'disabled' }}"
                           data-bs-toggle="tab"
                           data-bs-target="#kt_tab_pane_22" href="#kt_tab_pane_22">
                            <span class="svg-icon svg-icon-2 me-2">
                            </span>
                            {{__('Teams')}} </a>
                    </li>
                    <li class="nav-item mt-2" id="tab222">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5  {{ isset($insuranceCompany) ? '' : 'disabled' }}"
                           data-bs-toggle="tab"
                           data-bs-target="#kt_tab_pane_222" href="#kt_tab_pane_222">
                            <span class="svg-icon svg-icon-2 me-2">
                            </span>
                            {{__('Clients')}} </a>
                    </li>
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('insuranceCompanys.index') }}" class="btn btn-sm btn-light me-2"
                ...
                <a href="#" class="btn btn-sm btn-primary ms-5" data-kt-insuranceCompany-action="submit">
    ...
    <form class="tab-content" id="myTabContent" method="post"
          action="{{ route('insuranceCompanys.addedit', ['Id' => isset($insuranceCompany) ? $insuranceCompany->id : '']) }}?{{ isset($insuranceCompany) ? 'insuranceCompany_id=' . $insuranceCompany->id : '' }}">
        @csrf
        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_insuranceCompany_details_view">
                <!--begin::Card header-->
                ...
                <div class="card-body p-9">
                    <div class="row">
                        @include('insuranceCompanys.form')
                    </div>
                </div>
        ...
        <div class="tab-pane fade show " id="kt_tab_pane_bank" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_insuranceCompany_bank_view">
                <!--begin::Card header-->
                ...
                <div class="card-body p-9">
                    <div class="row">
                        @include('insuranceCompanys.bank')
                    </div>
                </div>
        ...
        <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_branches_details_view">
                <!--begin::Card header-->
                @if(isset($insuranceCompany))
                    @include('insuranceCompanys.branchs.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="kt_tab_pane_22" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_teams_details_view">
                <!--begin::Card header-->
                @if(isset($insuranceCompany))
                    @include('insuranceCompanys.teams.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
        <div class="tab-pane fade" id="kt_tab_pane_222" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_teams_clients_view">
                <!--begin::Card header-->
                @if(isset($insuranceCompany))
                    @include('insuranceCompanys.clients.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
            ...
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if(isset($insuranceCompany))
                        ...
                        @include('insuranceCompanys.attachments.index')
                    @endif
...
@push('scripts')
    ...
    <script>
        ...
        function renderValidate() {
            ...
            const submitButton = document.querySelector('[data-kt-insuranceCompany-action="submit"]');
