                ...
                <div class="card">
                    ...
                    <div class="card-body p-9">
                        <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                               id="kt_table_insuranceCompanyP_attachments">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        var initAtts = (function () {
            ...
            return function () {
                ...
                const columnDefs =
                    ...
                    datatableAtt = createDataTable('#kt_table_insuranceCompanyP_attachments', columnDefs,
                    "{{ route('insuranceCompanys.attachments', ['insuranceCompany' => $insuranceCompany->id]) }}",
                    [
                        [0, "ASC"]
                    ]);
