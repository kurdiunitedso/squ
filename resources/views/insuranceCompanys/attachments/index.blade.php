<div>
    <div class="card mb-5 mb-xl-10" id="kt_insuranceCompany_attachments_details_view">
        <!--begin::Card header-->
        ...
        <div class="card-body p-9">
            <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                   id="kt_table_insuranceCompany_attachments">
                <!--begin::Table head-->
                <thead>
                <!--begin::Table row-->
...
@push('scripts')
    <script>
        var table = document.querySelector('#kt_table_insuranceCompany_attachments');
        ...
        var  datatableAtt= $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('insuranceCompanys.attachments', ['insuranceCompany' => $insuranceCompany->id]) }}",
                type: "POST",
                data: function (d) {
                    // var params = {};
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function (e) {
            e.preventDefault();
            $(this).attr("data-kt-indicator", "on");
            renderModal("{{ route('insuranceCompanys.attachments.create', ['insuranceCompany' => $insuranceCompany->id]) }}", $(this));
        });
    ...
    <script>
        $(document).on('click', '.btnDeleteInsuranceCompanyAttachment', function (e) {
            e.preventDefault();
