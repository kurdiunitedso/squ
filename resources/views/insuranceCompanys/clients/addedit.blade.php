...
<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_add_client_header">
        <!--begin::Modal title-->
        <h2 class="fw-bold">{{ __('Add Client') }}</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_client_form" class="form"
              data-editMode="{{ isset($client) ? 'enabled' : 'disabled' }}"
              action="{{ isset($client) ? route('insuranceCompanys.clients.update', ['client' => $client->id]) : route('insuranceCompanys.clients.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_client_scroll" data-kt-scroll="true"
                ...
                <input type="hidden" name="insurance_company_id" value="{{isset($client)?$client->insurance_company_id:$insuranceCompany->id}}">
                @if(isset($client))
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="{{__('Client ID')}}">{{__('Client ID')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="Mobile">{{__('Total Orders Bot')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="orders_bot" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($client) ? $client->orders_bot : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="Mobile">{{__('Total Orders Now')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="orders_now" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($client) ? $client->orders_now : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="Mobile">{{__('Total Orders Box')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="orders_box" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($client) ? $client->orders_box : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class=" fw-semibold fs-6 mb-2"
                                   data-input-name="Policy Start Date">{{__('Last order Bot')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class=" fw-semibold fs-6 mb-2"
                                   data-input-name="Policy Start Date">{{__('Last order Now')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <div class="position-relative d-flex align-items-center">
                                <!--begin::Icon-->
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <!--end::Icon-->
                                <!--begin::Datepicker-->
                                <input type="text" name="last_orders_now"
                                       class="form-control form-control-solid ps-12 flatpickr-input mb-3 mb-lg-0" placeholder=""
                                       value="{{ isset($client) ? $client->last_orders_now : '' }}"/>
                                <!--end::Datepicker-->
                            </div>
                            <!--end::Input-->
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class=" fw-semibold fs-6 mb-2"
                                   data-input-name="Policy Start Date">{{__('Last order Box')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <div class="position-relative d-flex align-items-center">
                                <!--begin::Icon-->
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <!--end::Icon-->
                                <!--begin::Datepicker-->
                                <input type="text" name="last_orders_box"
                                       class="form-control form-control-solid ps-12 flatpickr-input mb-3 mb-lg-0" placeholder=""
                                       value="{{ isset($client) ? $client->last_orders_box : '' }}"/>
                                <!--end::Datepicker-->
                            </div>
                            <!--end::Input-->
                        </div>
            ...
            <div class="text-center pt-15">
                <button type="reset" class="btn btn-light me-3" data-kt-clients-modal-action="cancel"
