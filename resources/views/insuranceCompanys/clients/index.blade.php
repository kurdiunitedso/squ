            ...
            var initClients = (function () {
                ...
                return function () {
                    ...
                    datatableClient = createDataTable('#kt_table_clients', columnDefs,
                        "{{ route('insuranceCompanys.clients.index', ['insuranceCompany' => isset($insuranceCompany)?$insuranceCompany->id:0]) }}",
                        [
                            [0, "ASC"]
                        ]);
        ...
        <script>
            $(function () {
                ...
                $(document).on('click', '#AddClientModal', function (e) {
                    ...
                    globalRenderModal(
                        "{{ route('insuranceCompanys.clients.add', ['insuranceCompany_id' => isset($insuranceCompany) ? $insuranceCompany->id : '' ]) }}",
