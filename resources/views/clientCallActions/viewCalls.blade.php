<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-success mb-8">Telephone:{{$clientCallActions->telephone}}</h4>
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h4 class="text-primary" >{{__('Outgoing Calls')}}</h4>
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <h4 class="text-primary">{{__('Incoming Calls')}}</h4>
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading3">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <h4 class="text-primary">{{__('SMS Messages')}}</h4>
                            </button>
                        </h2>
                        ...
                        <div id="collapse33" class="accordion-collapse collapse" aria-labelledby="heading3"
                            ...
                            <div class="accordion-body">
                                <table class="table table-striped table-bordered table-hover  order-column" id="">
                                    ...
                                    <tbody>
                                    @php $count=1 @endphp
                                    @foreach (\App\Models\WhatsappHistory::getWhataaAppList([],0,0,0,$clientCallActions->telephone)->get() as $m)
