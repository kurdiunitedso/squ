@isset($captin)
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header align-items-center px-4 py-3">
                        ...
                        <div class="text-center flex-grow-1">
                            <div class="text-dark-75 font-weight-bold font-size-h5 whatsAppTtile">
                                <i class="la la-whatsapp text-success icon icon-xl"></i> Whatsapp {{$captin->mobile1}}
                                -{{$captin->name}}
                            </div>
                            {{--<div>
                                    ...
                                    @if($m->fromMe==0)
                                        <div class="d-flex flex-column mb-5 align-items-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="#"
                                                       class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">{{$captin->name}}</a>
                    ...
                    <form id="fromWhatsApp">
                        <div class="card-footer align-items-center">
                            <!--begin::Compose-->
                            <input type="hidden" name="mobile" id="chat_mobile" value="{{$captin->mobile1}}">
                            <input type="hidden" name="sender" id="chat_sender" value="Tabibfind">
                            <input type="hidden" name="patient" id="chat_patient" value="{{$captin->name}}">
    ...
    @push('scripts')
        ...
        <script>
            ...
            $("#AddAttachmentWhatsappModal").attr('link', 'dashbaord/createAtt?sender={{$sender}}&mobile={{$captin->mobile1}}');
        ...
        <script>
            ...
            $(document).on('click', '#AddAttachmentWhatsappModal', function (e) {
                ...
                renderModalWhats("{{ route('dashboard.createAtt') }}?sender={{$sender}}&mobile={{$captin->mobile1}}", $(this));
            });
        </script>
        <script>
