...
@section('content')
        ...
        <div class="card-body pt-0 pb-0">
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2" id="tabcv">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5" data-bs-toggle="tab"
                           data-bs-target="#kt_tab_pane_cv" href="#kt_tab_pane_cv">
                            <span class="svg-icon svg-icon-2 me-2">
                            </span>
                            {{__('CV')}} </a>
                    </li>
                    ...
                    <li class="nav-item mt-2" id="whatsapp">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5" data-bs-toggle="tab"
                           data-bs-target="#kt_tab_pane_whatsapp" href="#kt_tab_pane_whatsapp">
                            <span class="svg-icon svg-icon-2 me-2">
                            </span>
                            {{__('WhatsApp')}} </a>
                    </li>
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                @isset($captin)
                    <a href="#" id="AddvisitsModal"
                       url="{{route('visitRequests.create')}}?telephone={{$captin->mobile1}}&visit_name={{$captin->name}}&visit_category=251"
                       class="btn btn-info me-3">
                        ...
                        <span id="selectedCaptinsRowsCount"></span>Visit Request</a>
                @endisset
    ...
    <form class="tab-content" id="myTabContent" method="post"
        ...
        <div class="tab-pane fade" id="kt_tab_pane_cv" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_cv_view">
                <!--begin::Card header-->
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
    ...
    <div class="tab-pane fade" id="kt_tab_pane_whatsapp" role="tabpanel">
        <div class="card mb-5 mb-xl-10" id="kt_whatsapp_view">
            <!--begin::Card header-->
            <div class="card-header">
                <!--begin::Card title-->
                <div class="card-title m-0">
