<div class="card mb-5 mb-xl-10" id="kt_captin_details_view">
    ...
    <div class="card-header">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">{{ isset($captin) ? $captin->name  : __('Creating New captin') }} - {{ __('Details')}}</h3>
        </div>
        <!--end::Card title-->
        ...
        <div class="row">
           ...
           {{-- <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2" data-input-name="{{__('ID No')}}">{{__('ID')}}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="captin_id" class="form-control form-control-solid mb-3 mb-lg-0"
                           placeholder="" value="{{ isset($captin) ? $captin->captin_id : '' }}"/>
                    <!--end::Input-->
                </div>
            </div>
            <div class="col-md-4">
    ...
    {{--        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2"
                           data-input-name="Commission CASH">{{ __('Commission') }}%
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
