  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_attachment_form" class="form"
              ...
              action="{{ isset($attachment) ? route('restaurants.attachments.update', ['restaurant' => $restaurant->id, 'attachment' => $attachment->id]) : route('restaurants.attachments.store', ['restaurant' => $restaurant->id]) }}">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <div class="fv-row mb-7">
                              <!--begin::Label-->
                              <label class="required fw-semibold fs-6 mb-2">Attachment Type</label>
                              <!--end::Label-->
                              <!--begin::Input-->
