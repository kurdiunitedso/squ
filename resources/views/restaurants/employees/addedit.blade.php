...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_employee_form" class="form"
              ...
              action="{{ isset($employee) ? route('restaurants.employees.update', ['employee' => $employee->id]) : route('restaurants.employees.store') }}">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid mb-3 mb-lg-0 " data-control="select2"
                                ...
                                @foreach ($branches as $branch)
                                    ...
                                    @isset($employee)
                                        @selected($employee->restaurant_branch_id  == $branch->id)
                                        @endisset>
