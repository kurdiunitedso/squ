    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="email"
                   ...
                   placeholder="" value="{{ isset($restaurant) ? $restaurant->email : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="telephone"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder="" value="{{ isset($restaurant) ? $restaurant->telephone : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="whatsapp"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder="" value="{{ isset($restaurant) ? $restaurant->whatsapp : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
