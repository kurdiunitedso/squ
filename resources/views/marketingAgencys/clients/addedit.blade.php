...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_client_form" class="form"
              ...
              action="{{ isset($client) ? route('marketingAgencys.clients.update', ['client' => $client->id]) : route('marketingAgencys.clients.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_client_scroll" data-kt-scroll="true"
                ...
                <input type="hidden" name="marketing_agency_id" value="{{isset($client)?$client->marketing_agency_id:$marketingAgency->id}}">
                @if(isset($client))
