            ...
            var initTeams = (function() {
                ...
                return function() {
                    ...
                    datatableTeam = createDataTable('#kt_table_teams', columnDefs,
                        "{{ route('marketingAgencys.teams.index', ['marketingAgency' => isset($marketingAgency)?$marketingAgency->id:0]) }}",
                        [
                            [0, "ASC"]
                        ]);
        ...
        <script>
            $(function() {
                ...
                $(document).on('click', '#AddTeamModal', function(e) {
                    ...
                    globalRenderModal(
                        "{{ route('marketingAgencys.teams.add', ['marketingAgency_id' => isset($marketingAgency) ? $marketingAgency->id : '' ]) }}",
