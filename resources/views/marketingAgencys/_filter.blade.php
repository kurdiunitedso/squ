        ...
        <form id="filter-form" class="px-7 py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-10">
                        <!--begin::Label-->
                        <label class="form-label fw-semibold">{{__('Marketing Agency Type')}}:</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <div>
                            <select class="form-select form-select-solid datatable-input filter-selectpicker"
                                ...
                                <option></option>
                                @foreach ($types as $marketingAgency_type)
                                    <option
                                        value="{{ $marketingAgency_type->id }}">{{ $marketingAgency_type->name }}</option>
                                @endforeach
                            </select>
                        </div>
