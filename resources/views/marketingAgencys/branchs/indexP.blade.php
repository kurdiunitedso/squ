                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px all">{{__('Name')}}</th>
                                <th class="min-w-125px all">{{__('City')}}</th>
                                <th class="min-w-125px all">{{__('Address')}}</th>
                                <th class="min-w-125px all">{{__('Telephone')}}</th>
                                <th class="min-w-125px all">{{__('Floor')}}</th>
        ...
        var initBranchs = (function () {
            ...
            return function () {
                ...
                datatableBranch = createDataTable('#kt_table_branchs', columnDefs,
                    "{{ route('marketingAgencys.branchs.index', ['marketingAgency' => isset($marketingAgency)?$marketingAgency->id:0]) }}",
                    [
                        [0, "ASC"]
                    ]);
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '#AddBranchModal', function (e) {
                ...
                globalRenderModal(
                    "{{ route('marketingAgencys.branchs.add', ['marketingAgency_id' => isset($marketingAgency) ? $marketingAgency->id : '' ]) }}",
