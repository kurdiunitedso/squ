...
@section('title', 'MarketingAgency-' . 'Add new marketingAgency')
@section('subpageTitle', 'MarketingAgency')
@section('subpageName', 'Add new marketingAgency')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_marketingAgency_form_tabs">
        <div class="card-body pt-0 pb-0">
                ...
                <ul id="myTab"
                  ...
                  {{--  <li class="nav-item mt-2" id="tabbank">
                    ...
                    <li class="nav-item mt-2" id="tab2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($marketingAgency) ? '' : 'disabled' }} "
                           data-bs-toggle="tab"
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('marketingAgencys.index') }}" class="btn btn-sm btn-light me-2"
                ...
                <a href="#" class="btn btn-sm btn-primary ms-5" data-kt-marketingAgency-action="submit">
    ...
    <form class="tab-content" id="myTabContent" method="post"
          action="{{ route('marketingAgencys.addedit', ['Id' => isset($marketingAgency) ? $marketingAgency->id : '']) }}?{{ isset($marketingAgency) ? 'marketingAgency_id=' . $marketingAgency->id : '' }}">
        @csrf
        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_marketingAgency_details_view">
                <!--begin::Card header-->
   ...
   {{--     <div class="tab-pane fade show " id="kt_tab_pane_bank" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_marketingAgency_bank_view">
                <!--begin::Card header-->
        ...
        <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_branches_details_view">
                ...
                @if(isset($marketingAgency))
                    @include('marketingAgencys.branchs.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
--}}
        <div class="tab-pane fade" id="kt_tab_pane_22" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_teams_details_view">
                <!--begin::Card header-->
                @if(isset($marketingAgency))
                    @include('marketingAgencys.teams.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
        <div class="tab-pane fade" id="kt_tab_pane_222" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_teams_clients_view">
                <!--begin::Card header-->
                @if(isset($marketingAgency))
                    @include('marketingAgencys.clients.index')
                @endif
                <!--end::Card body-->
            </div>
        </div>
            ...
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if(isset($marketingAgency))
                        ...
                        @include('marketingAgencys.attachments.index')
                    @endif
...
@push('scripts')
    ...
    <script>
        ...
        function renderValidate() {
            ...
            const submitButton = document.querySelector('[data-kt-marketingAgency-action="submit"]');
