                ...
                <div class="card">
                    ...
                    <div class="card-body p-9">
                        <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                               id="kt_table_marketingAgencyP_attachments">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        var initAtts = (function () {
            ...
            return function () {
                ...
                const columnDefs =
                    ...
                    datatableAtt = createDataTable('#kt_table_marketingAgencyP_attachments', columnDefs,
                    "{{ route('marketingAgencys.attachments', ['marketingAgency' => $marketingAgency->id]) }}",
                    [
                        [0, "ASC"]
                    ]);
