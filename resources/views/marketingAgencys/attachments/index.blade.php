<div>
    <div class="card mb-5 mb-xl-10" id="kt_marketingAgency_attachments_details_view">
        <!--begin::Card header-->
        ...
        <div class="card-body p-9">
            <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                   id="kt_table_marketingAgency_attachments">
                <!--begin::Table head-->
                <thead>
                <!--begin::Table row-->
...
@push('scripts')
    <script>
        var table = document.querySelector('#kt_table_marketingAgency_attachments');
        ...
        var  datatableAtt= $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('marketingAgencys.attachments', ['marketingAgency' => $marketingAgency->id]) }}",
                type: "POST",
                data: function (d) {
                    // var params = {};
    ...
    <script>
        ...
        $(document).on('click', '#AddAttachmentModal', function (e) {
            e.preventDefault();
            $(this).attr("data-kt-indicator", "on");
            renderModal("{{ route('marketingAgencys.attachments.create', ['marketingAgency' => $marketingAgency->id]) }}", $(this));
        });
    ...
    <script>
        $(document).on('click', '.btnDeleteMarketingAgencyAttachment', function (e) {
            e.preventDefault();
