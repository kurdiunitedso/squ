            ...
            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                ...
                @foreach ($BANKS as $BANK)
                    ...
                    @isset($marketingAgency)
                        @selected($marketingAgency->bank_name == $BANK->id)
                        @endisset>
                        {{ $BANK->name }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="bank_branch"
                   ...
                   placeholder="" value="{{ isset($marketingAgency) ? $marketingAgency->bank_branch : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="bank_branch_no"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder="" value="{{ isset($marketingAgency) ? $marketingAgency->bank_branch_no : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="iban" class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder="" value="{{ isset($marketingAgency) ? $marketingAgency->iban : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
