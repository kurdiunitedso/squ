    ...
    <div class="modal-body scroll-y ">
        <form id="kt_modal_add_lead_form" class="form"
            ...
            <div class="card-body p-9">
                <div class="row">
                    <input type="hidden" name="visit_id" value="{{ isset($visit)?$visit->id:null}}">
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="owner_name" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->owner_name: (isset($visit)?$visit->visit_name:null) }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="owner_email" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->owner_email :  (isset($visit)?$visit->email:null)}}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="owner_mobile" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->owner_mobile :  (isset($visit)?$visit->telephone:null) }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="separator separator-dashed mb-3"></div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="manager_name" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->manager_name:  (isset($visit)?$visit->visit_name:null) }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="manager_email" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->manager_email :  (isset($visit)?$visit->email:null) }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="mobile" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder=""
                                   value="{{ isset($lead) ? $lead->mobile :  (isset($visit)?$visit->telephone:null) }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="separator separator-dashed mb-3"></div>
