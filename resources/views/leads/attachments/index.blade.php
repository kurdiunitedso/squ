<div>
    <div class="card mb-5 mb-xl-10" id="kt_lead_attachments_details_view">
        <!--begin::Card header-->
...
@push('scripts')
    <script>
        var table = document.querySelector('#kt_table_lead_attachments');
        ...
        var  datatableAtt= $(table).DataTable({
            ...
            ajax: {
                url: "{{ route('leads.attachments', ['lead' => $lead->id]) }}",
                type: "POST",
                data: function (d) {
                    // var params = {};
