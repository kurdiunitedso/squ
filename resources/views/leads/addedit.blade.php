...
@section('title', t(Lead::ui['s_ucf'] . '- Add new ' . Lead::ui['s_ucf']))
@section('subpageTitle', Lead::ui['s_ucf'])
@section('subpageName', 'Add new ' . Lead::ui['s_ucf'])
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_lead_form_tabs">
        <div class="card-body pt-0 pb-0">
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 " data-bs-toggle="tab"
                            data-bs-target="#kt_tab_pane_lead" href="#kt_tab_pane_lead">
                            <span class="svg-icon svg-icon-2 me-2">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($lead) ? '' : 'disabled' }}"
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('leads.index') }}" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                ...
                <a href="#" class="btn btn-sm btn-primary ms-5" data-kt-lead-action="submit">
    ...
    <form class="tab-content" id="myTabContent" method="post"
        action="{{ route('leads.addedit', ['Id' => isset($lead) ? $lead->id : '']) }}?{{ isset($lead) ? 'lead_id=' . $lead->id : '' }}">
        @csrf
        ...
        <div class="tab-pane fade  " id="kt_tab_pane_lead" role="tabpanel">
        ...
        <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if (isset($lead))
                        @include('leads.attachments.index')
                    @endif
...
@push('scripts')
    ...
    <script>
        ...
        function renderValidate() {
            ...
            const submitButton = document.querySelector('[data-kt-lead-action="submit"]');
        ...
        function renderAModal(url, button, modalId, modalBootstrap, validatorFields, formId, dataTableId,
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('[ name="team"]').select2({
                        ajax: {
                            url: '/getSelect?type=teamDepartment&department=' + $(
                    ...
                    $(document).on('change', '#department', function(e) {
                        $('[ name="team"]').select2({
                            ajax: {
                                url: '/getSelect?type=teamDepartment&department=' + $(this)
                                    .val(),
                                dataType: 'json',
                                data: function(params) {
                                    var query = {
        ...
        $(document).on('change', '#facility_id', function(e) {
            ...
            jQuery.ajax({
                ...
                success: function(data) {
                    ...
                    $('[name="need_internal_call_sys"]').val(data.data.need_internal_call_sys).trigger(
                        'change');
                    ...
                    $('[name="sys_satisfaction_rate"]').val(data.data.sys_satisfaction_rate).trigger(
                        'change');
