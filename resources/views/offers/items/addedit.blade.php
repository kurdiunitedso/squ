...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <!--begin::Scroll-->
        <form id="kt_modal_add_item_form" class="form" data-editMode="{{ isset($item) ? 'enabled' : 'disabled' }}"
            action="{{ isset($item) ? route('offers.items.update', ['item' => $item->id]) : route('offers.items.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_item_scroll" data-kt-scroll="true"
                ...
                <input type="hidden" id="facility_id" value="{{ $offer->facility_id }}">
                @if (isset($item))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid mb-3 mb-lg-0 description" name="description"
                                id="item" data-placeholder="Select an option">
                                <option></option>
                                @foreach ($items as $i)
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="notes" rows="4" class="form-control form-control-solid mb-3 mb-lg-0">{{ isset($item) ? $item->notes : '' }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" name="cost"
                                class="form-control form-control-solid calculation mb-3 mb-lg-0" placeholder=""
                                value="{{ isset($item) ? $item->cost : '0' }}" />
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <h1 class="text-primary  mb-3 mb-lg-0" id="total_cost">
                                {{ isset($item) ? $item->total_cost : '0' }}</h1>
                            <!--end::Input-->
                        </div>
                    </div>
