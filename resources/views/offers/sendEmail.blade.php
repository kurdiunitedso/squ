...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_email_form" class="form"
              ...
              action="{{route('offers.sendEmailTo')}}">
                    ...
                    <div class="col-lg-6">
                        <div class="fv-row mb-7">
                            <input type="text" name="to" class="form-control form-control-solid mb-3 mb-lg-0"
                                   ...
                                   placeholder="" value="{{ isset($offer) ? ($offer->facility?$offer->facility->email:'') : '' }}"/>
                        </div>
                    </div>
                </div>
                <div class="mb-5 row">
                    ...
                    <div class="col-lg-6">
                        <div class="fv-row mb-7">
                            <input type="text" name="subject" class="form-control form-control-solid mb-3 mb-lg-0"
                                   ...
                                   placeholder="" value="{{ isset($offer) ? ($offer->type?$offer->type->name:'') : '' }}"/>
                        </div>
                    </div>
                </div>
                <div class="mb-5 row">
