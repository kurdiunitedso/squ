...
@section('title', Contract::ui['p_ucf'])
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-col-index="search" data-kt-table-filter="search"
                                ...
                                placeholder="{{ t('Search ' . Contract::ui['s_ucf']) }}" />
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-departments-table-toolbar="base">
                            ...
                            <a target="_blank" id="exportBtn" href="#"
                                data-export-url="{{ route(Contract::ui['route'] . '.export') }}"
                            ...
                            <!--end::Filter-->
                            <!--begin::Add captins-->
                            <a href="{{ route(Contract::ui['route'] . '.create') }}" class="btn btn-primary"
                                id="add_{{ Contract::ui['s_lcf'] }}_modal">
                    ...
                    <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5" id="kt_table_items_model">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px bold all">{{ t('Client Name') }}</th>
                                ...
                                <th class="min-w-100px bold all">{{ t('Services') }}</th>
                                <th class="min-w-100px bold all">{{ t('Team Lead / Account Manager') }}</th>
                                <th class="min-w-100px bold all">{{ t('Approved By Manager') }}</th>
...
@push('scripts')
    <script>
        ...
        const columnDefs = [{
            ...
            {
                data: 'client_trillion.name',
                name: 'client_trillion.name',
                render: function(data, type, row) {
                    return row.client_trillion && row.client_trillion.name ? row.client_trillion.name : 'NA';
                }
            },
            {
                ...
                render: function(data, type, row) {
                    return row.contract_type && row.contract_type.name ? row.contract_type.name : 'NA';
                }
            },
            {
                data: 'duration',
                ...
                render: function(data) {
                    return data !== null && data !== undefined ? data : 'NA';
                }
            },
            {
                data: 'objectives',
    ...
    <script>
        $(document).on('click', '.btnDelete' + "{{ Contract::ui['s_ucf'] }}", function(e) {
            e.preventDefault();
            const URL = $(this).attr('href');
            const itemModelName = $(this).attr('data-' + "{{ Contract::ui['s_ucf'] }}" + '-name');
            Swal.fire({
