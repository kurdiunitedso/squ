            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-{{ ContractItem::ui['s_lcf'] }}-table-filter="search"
                            ...
                            placeholder="Search {{ ContractItem::ui['p_ucf'] }}" />
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-items-table-toolbar="base">
                        ...
                        <!--end::Filter-->
                        <!--begin::Add offers-->
                        <a href="#" class="btn btn-primary" id="add_{{ ContractItem::ui['s_lcf'] }}_modal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="contract_total_discount"
                                    style="font-size: 40px;color: red; text-align: center" id="contract_total_discount"
                                    class="form-control form-control-solid mb-3 mb-lg-0  validate-number validate-min-0"
                                    placeholder="" value="{{ isset($item_model) ? $item_model->total_discount : 0 }}" />
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="contract_total_cost" id="contract_total_cost" disabled
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                                    style="font-size: 40px;color: blue; text-align: center"
                                    value="{{ isset($item_model) ? $item_model->total_cost : '' }}" />
                                <!--end::Input-->
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    @if ($item_model)
        @include(Contract::ui['p_lcf'] . '.' . ContractItem::ui['p_lcf'] . '.scripts')
    @endif
