...
<div class="card mb-5 mb-xl-10" id="kt_clientTrillion_details_view">
    ...
    <div class="card-header">
        ...
        <div class="card-title m-0 w-600px">
            <select class="form-select form-select-solid mb-3 mb-lg-0 " id="{{ ClientTrillion::ui['_id'] }}"
                data-control="select2" name="{{ ClientTrillion::ui['_id'] }}"
                data-placeholder="{{ t('Select Client Trillion') }}" data-allow-clear="true">
                <option></option>
                {{-- @foreach ($clients as $c)
                    <option value="{{ $c->id }}"
                        @isset($policyOffer)
                        @selected($policyOffer->driver_id == $c->id)
                        @endisset>
                        {{ $c->name }}</option>
                @endforeach --}}
            </select>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 required">{{ __('Name Ar ') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 required">{{ __('Name En') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 ">{{ __('Name H') }}</label>
                    <!--hd::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 required">{{ __('Representative Name') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2">{{ __('Registration Name') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 ">{{ __('Registration Number ') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select form-select-solid mb-3 mb-lg-0 validate-required" data-control="select2"
                        name="country_id" data-placeholder="Select an option">
                        <option></option>
                ...
                <div class="fv-row mb-4">
                    ...
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        ...
                        @foreach ($company_types as $t)
                            <option value="{{ $t->id }}"
                                @if (isset($clientTrillion)) @selected($clientTrillion->company_type == $t->id) @endif>
                                {{ $t->name }}</option>
                        @endforeach
                    </select>
                    <!--end::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 ">{{ __('Client Trillion Address') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="address" class="form-control form-control-solid mb-3 mb-lg-0"
                        placeholder=""
                        value="{{ isset($clientTrillion) ? $clientTrillion->address : (isset($facility) ? $facility->address : null) }}" />
                    <!--end::Input-->
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7 ">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2 required">{{ __('Telephone') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2">{{ __('Fax') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    ...
                    <input type="email" name="email"
                        class="form-control form-control-solid mb-3 mb-lg-0 validate-required validate-email"
                        placeholder=""
