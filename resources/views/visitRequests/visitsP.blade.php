<div class="col-md-12">
    ...
    <table class="table table-bordered align-middle table-row-dashed table-responsive" id="kt_table_visitHistory">
        ...
        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="min-w-250px  bold all">{{__('Details')}}</th>
...
<script>
    ...
    @if(isset($visitRequest))
    var iddd = '{{$visitRequest->id}}';
    ...
    var datatableVisits = createDataTable('#kt_table_visitHistory', columnDefsVisits, "{{ route('visits.indexByPhone') }}?id=" + iddd, [
        [0, "ASC"]
    ]);
