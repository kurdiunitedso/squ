<div class="modal-content">
    ...
    <div class="modal-header" id="kt_modal_add_visit_header">
        <!--begin::Modal title-->
        <h2 class="fw-bold">{{__('Add Visit Request')}} -  {{isset($names)?$names:''}}</h2>
        <!--end::Modal title-->
        <!--begin::Close-->
    ...
    <div class="modal-body scroll-y mx-5 my-7">
        ...
        <form id="kt_modal_add_visit_form" class="form"
              ...
              action="{{ isset($visit) ? route('visitRequests.update', ['visit' => $visit->id]) : route('visitRequests.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_visit_scroll"
                ...
                <!--begin::Input group-->
                @if($selectedCaptins)
                    <input type="hidden" name="visit_category" id="category" value="{{isset($visit_category)?$visit_category:249}}">
                    <div class="row">
                        <input type="hidden" name="selectedCaptins" value="{{$selectedCaptins}}">
                                ...
                                <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                    ...
                                    @foreach ($category as $t)
                                        ...
                                        @if (isset($visit))
                                            ...
                                            @endif
                                            @selected(app()->request->visit_category ==$t->id)
                                        >
                        ...
                        <div class="col-md-4">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2 required">{{__('Purpose')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        ...
                        <div class="col-md-4">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2 required">{{__('Visit Type')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                        name="visit_type" id="visit_type" data-placeholder="Select an option">
                                    <option></option>
                        ...
                        <div class="col-md-4 ">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2  required">{{__('Department')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                    ...
                                    @foreach ($ticket_type as $t)
                                        <option value="{{ $t->id }}"
                                        @if (isset($ticket))
                                            @selected($ticket->department ==$t->id)
                                            @endif>
                                            {{ $t->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2  required">{{__('Employee')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        ...
                        <div class="col-md-12">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2 required">{{__('Details')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                ...
                @elseif($selectedRestaurants)
                    <div class="row">
                        <input type="hidden" name="visit_category" id="category" value="{{app()->request->visit_category}}">
                        <input type="hidden" name="selectedRestaurants" value="{{$selectedRestaurants}}">
                        <div class="col-md-4 d-none">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2">{{__('Category')}}</label>
                ...
                @elseif( isset($selectedClients))
                    <div class="row">
                        <input type="hidden" name="visit_category" id="category" value="{{app()->request->visit_category}}">
                        <input type="hidden" name="selectedClients" value="{{$selectedClients}}">
                        <div class="col-md-4 d-none">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2">{{__('Category')}}</label>
                ...
                @elseif(isset($selectedClientTrillions))

                    <div class="row">
                        <input type="hidden" name="visit_category" id="category" value="{{app()->request->visit_category}}">
                        <input type="hidden" name="selectedClientTrillions" value="{{$selectedClientTrillions}}">
                        <div class="col-md-4 d-none">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2">{{__('Category')}}</label>
                ...
                @elseif(isset($selectedFacilities))
                    <div class="row">
                        <input type="hidden" name="visit_category" id="category" value="{{app()->request->visit_category}}">
                        <input type="hidden" name="selectedFacilities" value="{{$selectedFacilities}}">
                        <div class="col-md-4 d-none">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2">{{__('Category')}}</label>
                ...
                @else
                    <div class="row">
                        ...
                        <div class="col-md-4 {{app()->request->visit_category?'d-none':''}}">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                <label class=" fw-semibold fs-6 mb-2">{{__('Category')}}</label>
                                <!--end::Label-->
                        ...
                        <div class="col-md-4  {{app()->request->visit_name?'d-none':''}}">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                ...
                                <input type="text" name="visit_name"
                                       ...
                                       placeholder="{{__('Name')}}"
                                       value="{{app()->request->visit_name }}{{ isset($visit) ? $visit->visit_name : '' }}"/>
                                <!--end::Input-->
                            </div>
                        </div>

                        <div class="col-md-4  {{app()->request->telephone?'d-none':''}}  ">
                            <div class="fv-row mb-4">
                                <!--begin::Label-->
                                ...
                                <input type="text" name="telephone" class="form-control form-control-solid mb-3 mb-lg-0"
                                       value="{{app()->request->telephone }}{{ isset($visit) ? $visit->telephone : '' }}"/>
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="col-md-4">
