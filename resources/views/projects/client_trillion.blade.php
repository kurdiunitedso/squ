<div class="card mb-5 mb-xl-10" id="kt_clientTrillion_details_view">
    ...
    <div class="card-header">
        ...
        <div class="card-title m-0 w-600px">
            <select class="form-select form-select-solid mb-3 mb-lg-0" id="client_trillion_id" data-control="select2"
                name="client_trillion_id" data-placeholder="{{ t('Select Client Trillion') }}" data-allow-clear="true">
                <option></option>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2" name="country_id"
            ...
            <div class="col-md-4">
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2" name="city_id"
                        data-placeholder="Select an option">
                        <option></option>
