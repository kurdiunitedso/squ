                    ...
                    <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5" id="kt_table_items_model">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px bold all">{{ t('Sale ID') }}</th>
                                <th class="min-w-200px bold all">{{ t('Client Name') }}</th>
                                <th class="min-w-200px bold all">{{ t('Apartment') }}</th>
                                <th class="min-w-100px bold all">{{ t('Total Amount') }}</th>
                                <th class="min-w-100px bold all">{{ t('Down Payment') }}</th>
                                <th class="min-w-100px bold all">{{ t('Installment Amount') }}</th>
                                <th class="min-w-100px bold all">{{ t('Installments') }}</th>
                                <th class="min-w-100px bold all">{{ t('Start Date') }}</th>
                                <th class="min-w-100px bold all">{{ t('Payment Frequency') }}</th>
