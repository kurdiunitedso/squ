...
@section('content')
                ...
                <ul id="myTab"
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 " data-bs-toggle="tab"
                            data-bs-target="#kt_tab_pane_{{ Lead::ui['s_lcf'] }}"
                            href="#kt_tab_pane_{{ Lead::ui['s_lcf'] }}">
                            <span class="svg-icon svg-icon-2 me-2">
    ...
    <form class="tab-content" id="{{ $_model::ui['s_lcf'] }}_form" method="post"
        ...
        <div class="tab-pane fade show" id="kt_tab_pane_{{ Lead::ui['s_lcf'] }}" role="tabpanel">
            @include($_view_path . '.tabs.lead')
