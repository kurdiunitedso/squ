...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-3">
        <!--begin::Menu wrapper-->
        <div class="btn btn-icon btn-custom btn-icon-muted ShowChatWhats btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative"
            id="kt_drawer_chat_toggle" link="/getUnreadMessages?sender=EMC">
            ...
            <!--end::Svg Icon-->
            <span id="countWA"
                class="bullet bullet-dot countWA bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink">
            </span>
        </div>
    ...
    <div class="app-navbar-item ms-1 ms-md-3">
        <div class="btn btn-icon btn-custom btn-icon-muted  btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative"
            onclick="window.open('/', '_blank')" title="Go Website">
            <!--begin::Home Icon-->
    ...
    <div class="app-navbar-item ms-1 ms-md-3">
        <!--layout-partial:partials/theme-mode/_main.html-->
        @include('CP.metronic.partials.theme-mode._main')
    </div>
    <!--end::Theme mode-->
    <!--begin::User menu-->
