<div class="card mb-5 mb-xl-10" id="kt_captin_details_view">
    ...
    <div class="card-body p-9">
        ...
        @if(isset($policyOffer))
            <div class="row">
                <div class="col-md-4">
                    <a href="#" class="btn btn-sm btn-primary ms-5 w-100" attachemnt_type="Client Image"
                       id="AddAttachmentModal">
                            <span class="indicator-label">
                                  <i class="fa fa-upload svg-icon-lg"></i>
                                {{__('Client Image')}}</span>
                ...
                <div class="col-md-2">
                    <a href="{{route('policyOffers.attachments.edit', ['policyOffer' => $policyOffer->id, 'attachment' => isset($captin_image)?$captin_image->id:'0']) }}"
                       attachment="{{isset($captin_image)?$captin_image->id:'0'}}" attachemnt_type="Client Image"
                       id="307" class="btn btn-sm btn-warning {{isset($captin_image)?'':'d-none'}} btnUpdateAttachment">
                ...
                <div class="col-md-4">
                    <a href="#" class="btn btn-sm btn-primary ms-5  w-100" attachemnt_type="Driving License"
                       id="AddAttachmentModal">
                            <span class="indicator-label">
                                <span class="svg-icon svg-icon-2">
                                  <i class="fa fa-upload svg-icon-lg"></i>
                                </span>
                                {{__('Driving License')}}</span>
                        <span class="indicator-progress">
                                Please wait... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                            </span>
                    </a>
                ...
                <div class="col-md-2">
                    <a href="{{route('policyOffers.attachments.edit', ['policyOffer' => $policyOffer->id, 'attachment' => isset($driving_license)?$driving_license->id:'0']) }}"
                       attachment="{{isset($driving_license)?$driving_license->id:'0'}}" id="308"
                       attachemnt_type="Driving License"
                       class="btn btn-sm btn-warning {{isset($driving_license)?'':'d-none'}} btnUpdateAttachment">
                <span class="svg-icon svg-icon-3">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd"
                      d="M2 4.63158C2 3.1782 3.1782 2 4.63158 2H13.47C14.0155 2 14.278 2.66919 13.8778 3.04006L12.4556 4.35821C11.9009 4.87228 11.1726 5.15789 10.4163 5.15789H7.1579C6.05333 5.15789 5.15789 6.05333 5.15789 7.1579V16.8421C5.15789 17.9467 6.05333 18.8421 7.1579 18.8421H16.8421C17.9467 18.8421 18.8421 17.9467 18.8421 16.8421V13.7518C18.8421 12.927 19.1817 12.1387 19.7809 11.572L20.9878 10.4308C21.3703 10.0691 22 10.3403 22 10.8668V19.3684C22 20.8218 20.8218 22 19.3684 22H4.63158C3.1782 22 2 20.8218 2 19.3684V4.63158Z"
