            ...
            <div class="card-body py-4 ">
                ...
                <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5 "
                    ...
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="all min-w-125px">{{__('Name')}}</th>
                        <th class="all min-w-125px">{{__('Mobile')}}</th>

                        <th class="all min-w-125px">{{__('Title')}}</th>
                        <th class="all min-w-125px">{{__('Email')}}</th>

                        <th class="all min-w-125px">{{__('Shift')}}</th>
                        <th class="all min-w-125px">{{__('Department')}}</th>
                        <th class="all min-w-125px">{{__('Create Date')}}</th>
            ...
            var initTeams = (function() {
                ...
                return function() {
                    ...
                    datatableTeam = createDataTable('#kt_table_teams', columnDefs,
                        "{{ route('clientTrillions.teams.index', ['clientTrillion' => isset($clientTrillion)?$clientTrillion->id:0]) }}",
                        [
                            [0, "ASC"]
                        ]);
        ...
        <script>
            $(function() {
                ...
                $(document).on('click', '#AddTeamModal', function(e) {
                    ...
                    globalRenderModal(
                        "{{ route('clientTrillions.teams.add', ['clientTrillion' => isset($clientTrillion) ? $clientTrillion->id : '' ]) }}",
