...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <form id="kt_modal_add_team_form" class="form"
              ...
              action="{{ isset($team) ? route('clientTrillions.teams.update', ['team' => $team->id]) : route('clientTrillions.teams.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_team_scroll" data-kt-scroll="true"
                ...
                <div class="row">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                ...
                                @foreach ($titles as $title)
                                    ...
                                    @isset($team)
                                        @selected($team->title_id == $title->id)
                                        @endisset>
                                        {{ $title->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name_en="Name_En">
                                {{ __('Name En') }}
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_en" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($team) ? $team->name_en : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name_h="Name_H">
                                {{ __('Name H') }}
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_h" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($team) ? $team->name_h : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" data-input-name="Telephone">
                                {{ __('Telephone') }}
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="telephone" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($team) ? $team->telephone : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="fax" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="" value="{{ isset($team) ? $team->fax : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="shift">
                                {{ __('Shift') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            ...
                            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                ...
                                @foreach ($shifts as $shift)
                                    ...
                                    @isset($team)
                                        @selected($team->schedule_id == $shift->id)
                                        @endisset>
                                        {{ $shift->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fw-semibold fs-6 mb-2" data-input-name="department">
                                {{ __('Department') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            ...
                            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                                ...
                                @foreach ($departments as $department)
                                    ...
                                    @isset($team)
                                        @selected($team->department_id == $department->id)
                                        @endisset>
