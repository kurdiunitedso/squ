<div class="modal-content">
    ...
    <div class="modal-body scroll-y ">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-success mb-8">Telephone:{{$clientTrillion->telephone}}</h2>
                        ...
                        <div id="collapse33" class="accordion-collapse collapse" aria-labelledby="heading3"
                            ...
                            <div class="accordion-body">
                                <table class="table table-striped table-bordered table-hover  order-column" id="">
                                    ...
                                    <tbody>
                                    @php $count=1 @endphp
                                    @foreach (\App\Models\WhatsappHistory::getWhataaAppList([],0,0,0,$clientTrillion->telephone)->get() as $m)
