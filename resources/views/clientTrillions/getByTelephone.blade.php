...
<div class="modal-content">
    <!--begin::Modal header-->
    <div class="modal-header" id="kt_modal_add_clientTrillion_header">
        <!--begin::Modal preparation_time-->
        <h2 class="fw-bold">{{ __('View ClientTrillion') }}</h2>
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                            ...
                            @foreach($clientTrillions as $b)
                                <tr class="text-start fs-7  gs-0">
                                    <td>{{$b->id}}</td>
                                    <td><a href="{{route('clientTrillions.edit', ['clientTrillion' => $b->id])}}" target="_blank" > {{$b->full_name}}</a></td>
                                    <td>{{$b->city->name}}</td>
                                    <td>{{$b->address}}</td>
                                    <td>
                                        {{$b->mobile1}}</td>
        ...
        <div class="text-center pt-15">
            <button type="reset" class="btn btn-light me-3" data-kt-clientTrillions-modal-action="cancel"
