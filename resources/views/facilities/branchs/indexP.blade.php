<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-branchs-table-filter="searchBranch"
    ...
    @isset($facility)
            ...
            var initBranchs = (function() {
                ...
                return function() {
                    ...
                    datatableBranch = createDataTable('#kt_table_branchs', columnDefs,
                        "{{ route('facilities.branchs.index', ['facility' => isset($facility)?$facility->id:0]) }}",
                        [
                            [0, "ASC"]
                        ]);
        ...
        <script>
            const filterSearchBranchs = document.querySelector('[data-kt-branchs-table-filter="searchBranch"]');
        ...
        <script>
            $(function() {
                ...
                $(document).on('click', '#AddBranchModal', function(e) {
                    ...
                    globalRenderModal(
                        "{{ route('facilities.branchs.add', ['facility_id' => isset($facility) ? $facility->id : '' ]) }}",
