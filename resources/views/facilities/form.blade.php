<div class="card mb-5 mb-xl-10" id="kt_facility_details_view">
    ...
    <div class="card-header">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">{{ isset($facility) ? $facility->name . ' - Details' : 'Creating New facility' }}
            </h3>
        </div>
        <!--end::Card title-->
        @hasrole('super-admin')
            <div class="card-toolbar">
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active" name="active_active"
                            @isset($facility)
                        @checked($facility->active == 1)
                        @endisset>
                        <label class="form-check-label cursor-pointer text-primary fw-semibold fs-6" for="status">
                            {{ __('Active') }}</label>
                    </div>
                </div>
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch" id="has_branch_select">
                        <input class="form-check-input" type="checkbox" role="switch" id="has_branch"
                            @if (isset($facility)) @checked($facility->has_branch == 1)
                               @if ($facility->has_branch)
                                   value="on"
                           @else
                               value="off" @endif
                        @else value="off" @endif

                        name="has_branch_active">
                ...
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch" id="has_marketing_select">
                        <input class="form-check-input" type="checkbox" role="switch" id="has_marketing"
                            @if (isset($facility)) @checked($facility->has_marketing == 1)
                               @if ($facility->has_marketing)
                                   value="on"
                           @else
                               value="off" @endif
                        @else value="off" @endif
                        name="has_marketing_active">
                ...
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active"
                            name="has_wheels_b2b_active"
                            @isset($facility)
                        @checked($facility->has_wheels_b2b == 1)
                        @endisset>
                        <label class="form-check-label cursor-pointer text-primary fw-semibold fs-6" for="status">
                            {{ __('B2B') }}</label>
                    </div>
                ...
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active"
                            name="has_wheels_bot_active"
                            @isset($facility)
                        @checked($facility->has_wheels_bot == 1)
                        @endisset>
                        <label class="form-check-label cursor-pointer text-primary fw-semibold fs-6" for="status">
                            {{ __('Bot') }}</label>
                    </div>
                ...
                <div class="align-items-center d-flex flex-row me-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active"
                            name="has_wheels_now_active"
                            @isset($facility)
                        @checked($facility->has_wheels_now == 1)
                        @endisset>
                        <label class="form-check-label cursor-pointer text-primary fw-semibold fs-6" for="status">
                            {{ __('Now') }}</label>
                    </div>
    ...
    <div class="card-body p-9">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="Facility ID">{{ __('Facility ID') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="facility_id" class="form-control form-control-solid mb-3 mb-lg-0"
                        placeholder="" value="{{ isset($facility) ? $facility->facility_id : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="Category">{{ __('Category') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        name="has_call_center" data-placeholder="Select an option">
                        <option></option>
                        <option value="1"
                            @isset($facility)
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <label class=" fw-semibold fs-6 mb-2"
                        data-input-name="Need internal call
                        center system?">
                    ...
                    <!--begin::Input-->
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        name="need_internal_call_sys" data-placeholder="Select an option">
                        <option></option>
                        <option value="1"
                            @isset($facility)
           ...
           <div class="col-md-3">
                  <div class="fv-row mb-7">
                      <!--begin::Label-->
                      <label class=" fw-semibold fs-6 mb-2" data-input-name="has_box">
                          {{ __('Has Box') }}
                      </label>
                      <!--end::Label-->
                      <!--begin::Input-->
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="Has pos">
                        {{ __('Has POS') }}
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <!--begin::Input-->
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                        name="printer_type" data-placeholder="Select an option">
                        <option></option>
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="POS Type">
                        {{ __('POS Type') }} </label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2" name="pos_type"
                        data-placeholder="Select an option">
                        <option></option>
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="annual_subscription"
                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                        value="{{ isset($facility) ? $facility->annual_subscription : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="Operating system type">
            ...
            <div class="col-md-3 d-none d-none">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2" data-input-name="Total Orders">{{ __('Total Orders') }}
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" disabled name="total_orders"
                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                        value="{{ isset($facility) ? $facility->total_orders : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
            <div class="col-md-3 d-none">
                <div class="fv-row mb-7">
                    ...
                    <input type="number" disabled name="total_sales_cash"
                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                        value="{{ isset($facility) ? $facility->total_sales_cash : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
            ...
            <div class="col-md-3 d-none">
                <div class="fv-row mb-7">
                    ...
                    <input type="number" disabled name="total_sales_visa"
                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                        value="{{ isset($facility) ? $facility->total_sales_visa : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
            <div class="col-md-3">
                <div class="fv-row mb-4">
                    <!--begin::Label-->
                    <label class=" fw-semibold fs-6 mb-2" data-input-name="Join Date">{{ __('Join Date') }}</label>
                    <!--end::Label-->
                    <!--begin::Input-->
            ...
            {{--     <div class="col-md-3">
                         <div class="fv-row mb-7">
                             <!--begin::Label-->
                             <label class=" fw-semibold fs-6 mb-2" data-input-name="has_branch">Has Branch</label>
                             <!--end::Label-->
                             <!--begin::Input-->
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="fw-semibold fs-6 mb-2" data-input-name="">{{ __('Representative Name') }}
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="representative_name"
                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                        value="{{ isset($facility) ? $facility->representative_name : '' }}" />
                    <!--end::Input-->
                </div>
            </div>
