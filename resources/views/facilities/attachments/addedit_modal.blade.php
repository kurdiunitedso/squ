  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_attachment_form" class="form"
              ...
              action="{{ isset($attachment) ? route('facilities.attachments.update', ['facility' => $facility->id, 'attachment' => $attachment->id]) : route('facilities.attachments.store', ['facility' => $facility->id]) }}">
