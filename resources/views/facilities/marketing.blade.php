    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="facebook_address"
                   ...
                   placeholder=""
                   value="{{ isset($facility) ? $facility->facebook_address : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="instagram_address"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder=""
                   value="{{ isset($facility) ? $facility->instagram_address : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="tiktok_address"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder=""
                   value="{{ isset($facility) ? $facility->tiktok_address : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                    name="has_marketing_center_active"
                    data-placeholder="Select an option">
                <option></option>
                <option value="1"
                @isset($facility)
                    @selected($facility->has_marketing_center == '1')
                    @endisset>
                    {{ __('YES') }}
                </option>
                <option value="0"
                @isset($facility)
                    @selected($facility->has_marketing_center == '0')
                    @endisset>
                    {{ __('NO') }}
                </option>
            </select>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2"
                ...
                <option value="1"
                @isset($facility)
                    @selected($facility->interst_to_market == '1')
                    @endisset>
                    {{ __('YES') }}
                </option>
                <option value="0"
                @isset($facility)
                    @selected($facility->interst_to_market == '0')
                    @endisset>
                    {{ __('NO') }}
                </option>
            </select>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="marketing_rep_name"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder=""
                   value="{{ isset($facility) ? $facility->marketing_rep_name : '' }}"/>
            <!--end::Input-->
        </div>
    </div>--}}
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="marketing_rep_co_name"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder=""
                   value="{{ isset($facility) ? $facility->marketing_rep_co_name : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="fv-row mb-7">
            ...
            <input type="text" name="pay_to_marketing_agent_amount"
                   class="form-control form-control-solid mb-3 mb-lg-0"
                   placeholder=""
                   value="{{ isset($facility) ? $facility->pay_to_marketing_agent_amount : '' }}"/>
            <!--end::Input-->
        </div>
    </div>
