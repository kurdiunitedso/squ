...
@section('title', 'facility-' . 'Add new facility')
@section('subpageTitle', 'facility')
@section('subpageName', 'Add new facility')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_facility_form_tabs">
                ...
                <ul id="myTab"
                   ...
                   {{-- <li class="nav-item mt-2">
                    ...
                    <li class="nav-item mt-2" id="tab3">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5  {{ isset($facility)&&$facility->has_marketing ? '' : 'd-none' }}"
                           data-bs-toggle="tab"
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($facility)&&$facility->has_branch ? '' : 'd-none' }}  {{ isset($facility) ? '' : 'disabled' }}"
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-6 px-2 py-5 {{ isset($facility) ? '' : 'disabled' }}"
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                @isset($facility)
                    <a href="#" id="AddvisitsModal"
                       url="{{route('visitRequests.create')}}?telephone={{$facility->telephone}}&visit_name={{$facility->name}}&visit_category=249"
                       class="btn btn-info me-3">
                        ...
                        <span id="selectedFacilitiesRowsCount"></span>Visit Request</a>
                @endisset
                <a href="{{ route('facilities.index') }}" class="btn btn-sm btn-light me-2"
                ...
                <a href="#" class="btn btn-sm btn-primary ms-5" data-kt-facility-action="submit">
    ...
    <form class="tab-content" id="myTabContent" method="post"
          action="{{ route('facilities.addedit', ['Id' => isset($facility) ? $facility->id : '']) }}?{{ isset($facility) ? 'facility_id=' . $facility->id : '' }}">
        @csrf
            ...
            <div class="card mb-5 mb-xl-10" id="kt_facility_details_view">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">{{__('Facility Details')}}</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
     ...
     {{--   <div class="tab-pane fade" id="kt_tab_pane_contact" role="tabpanel">
        ...
        <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_employee_view">
                ...
                <div class="card-body p-9">
                    @include('facilities.employees.index')
                </div>
                <!--end::Card body-->
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="kt_tab_pane_6" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_branch_view">
                ...
                <!--begin::Card body-->
                <div class="card-body p-9">
                    @include('facilities.branchs.index')
                </div>
                <!--end::Card body-->
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    @if(isset($facility))
                        @include('facilities.attachments.index')
                    @endif
                </div>
                <!--end::Card body-->
            </div>
        ...
        <div class="tab-pane fade" id="kt_tab_pane_8" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_attachments_view">
                ...
                <div class="card-body p-9">
                    ...
                    @include('facilities.history.index')
...
@push('scripts')
    ...
    <script>
        ...
        function renderValidate() {
            ...
            const submitButton = document.querySelector('[data-kt-facility-action="submit"]');
